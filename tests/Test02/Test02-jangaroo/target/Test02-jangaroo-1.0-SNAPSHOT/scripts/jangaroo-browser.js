...
joo.classLoader.prepare("package js",[""],
"public interface CanvasGradient",function($$private){with($$private)return[
...
joo.classLoader.prepare("package js",[""],
"public interface CanvasPattern",function($$private){with($$private)return[

];},[],[]
);
// class js.CanvasRenderingContext2D
joo.classLoader.prepare("package js",[""],
"public interface CanvasRenderingContext2D",function($$private){with($$private)return[
...
joo.classLoader.prepare("package js",[""],
"public class CSSPrimitiveValue",function($$private){with($$private)return[
...
"public class Document extends js.Node",function($$private){with($$private)return[
...
// class js.Event
joo.classLoader.prepare("package js",[""],
"public class Event",function($$private){with($$private)return[
"public native function get type",
...
joo.classLoader.prepare("package js",[""],
"public class HTMLCanvasElement extends js.HTMLElement",function($$private){with($$private)return[
...
joo.classLoader.prepare("package js",[""],
"public class HTMLElement extends js.Element",function($$private){with($$private)return[
];},[],["js.Element"]
);
...
// class js.ImageData
joo.classLoader.prepare("package js",[""],
"public interface ImageData",function($$private){with($$private)return[
...
// class js.Range
joo.classLoader.prepare("package js",[""],
"public class Range",function($$private){with($$private)return[
...
// class js.Screen
joo.classLoader.prepare("package js",[""],
"public class Screen",function($$private){with($$private)return[
...
"public interface Selection",function($$private){with($$private)return[
...
"public class Style",function($$private){with($$private)return[
...
joo.classLoader.prepare("package js",[""],
"public interface TextMetrics",function($$private){with($$private)return[
,
];},[],[]
);
// class js.TextNode
joo.classLoader.prepare("package js",[""],
"public class TextNode extends js.Node",function($$private){with($$private)return[
...
"public class Window",function($$private){with($$private)return[
