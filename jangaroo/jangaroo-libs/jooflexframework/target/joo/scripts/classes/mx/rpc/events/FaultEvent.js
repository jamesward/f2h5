...
"public class FaultEvent extends mx.rpc.events.AbstractEvent",function($$l,$$private){var is=joo.is,assert=joo.assert,trace=joo.trace,$$bound=joo.boundMethod,$super=$$l+'super',$clone=$$l+'clone',$toString=$$l+'toString',$callTokenResponders=$$l+'callTokenResponders',$_fault=$$l+'_fault',$_headers=$$l+'_headers',$_statusCode=$$l+'_statusCode';return[function(){joo.classLoader.init(mx.rpc.Fault,mx.messaging.messages.AbstractMessage);},
    ...
    */
     ...
     *  @productversion Flex 3
     */
    "public function FaultEvent",function $FaultEvent(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = true*/,
     ...
     *  @productversion Flex 3
     */
    "public function get fault",function get$fault()/*:Fault*/
    {
        return this[$_fault];
    },
     ...
     *  @productversion Flex 3
     */ 
    "public static function createEventFromMessageFault",function createEventFromMessageFault(value/*:MessageFaultEvent*/, token/*:AsyncToken = null*/)/*:FaultEvent*/
    {if(arguments.length<2){token = null;}
        var fault/*:Fault*/ = new mx.rpc.Fault(value.faultCode, value.faultString, value.faultDetail);
     ...
     *  @productversion Flex 3
     */ 
    "public static function createEvent",function createEvent(fault/*:Fault*/, token/*:AsyncToken = null*/, msg/*:IMessage = null*/)/*:FaultEvent*/
    ...
    "private var",{ _fault/*:Fault*/: undefined},
