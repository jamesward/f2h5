...
"public static const",{ VERSION/*:String*/ : "4.1.0.16076"},
     ...
     * 
     */
    "public static var",{ urlFilters/*:Array*/ :function(){return( 
            [
     ...
     *  @productversion Flex 3
     */
    "public static function normalizeURL",function normalizeURL(loaderInfo/*:LoaderInfo*/)/*:String*/
    {
        var url/*:String*/ = loaderInfo.url;
        var index/*:int*/;
        var searchString/*:String*/;
        var urlFilter/*:Function*/;
        var n/*:uint*/ = mx.utils.LoaderUtil.urlFilters.length;
     ...
     */ 
    "public static function createAbsoluteURL",function createAbsoluteURL(rootURL/*:String*/, url/*:String*/)/*:String*/
    {
     ...
     *  @private
     */
    "private static function isMac",function isMac()/*:Boolean*/
    {
     ...
     */
    "private static function dynamicURLFilter",function dynamicURLFilter(url/*:String*/, index/*:int*/)/*:String*/
    {
     ...
     */
    "private static function importURLFilter",function importURLFilter(url/*:String*/, index/*:int*/)/*:String*/
    {
