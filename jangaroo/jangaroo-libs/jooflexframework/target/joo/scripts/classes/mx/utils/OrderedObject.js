...
"public dynamic class OrderedObject extends flash.utils.Proxy",function($$l,$$private){var is=joo.is,assert=joo.assert,trace=joo.trace,$$bound=joo.boundMethod,$super=$$l+'super',$_item=$$l+'_item',$getProperty=$$l+'getProperty',$callProperty=$$l+'callProperty',$deleteProperty=$$l+'deleteProperty',$hasProperty=$$l+'hasProperty',$nextName=$$l+'nextName',$nextNameIndex=$$l+'nextNameIndex',$nextValue=$$l+'nextValue',$setProperty=$$l+'setProperty';return[
     ...
     *  @productversion Flex 3
     */
    "public function OrderedObject",function $OrderedObject(item/*:Object=null*/)
     ...
     *  @productversion Flex 3
     */
    "public var",{ propertyList/*:Array*/: undefined},
     ...
     *  @productversion Flex 3
     */
    "private var",{ _item/*:Object*/: undefined},
     ...
     *  @productversion Flex 3
     */
    "public function getObjectProperty",function getObjectProperty(name/*:**/)/*:**/
    {
     ...
     *  @productversion Flex 3
     */
    "public function setObjectProperty",function setObjectProperty(name/*:**/, value/*:**/)/*:void*/
    {
     ...
     *  @productversion Flex 3
     */
    "override public function getProperty",function getProperty(name/*:**/)/*:**/
    {
     ...
     *  @productversion Flex 3
     */
    "override public function callProperty",function callProperty(name/*:*, ... rest*/)/*:**/
     ...
     *  @productversion Flex 3
     */
    "override public function deleteProperty",function deleteProperty(name/*:**/)/*:Boolean*/
    {
     ...
     *  @productversion Flex 3
     */
    "override public function hasProperty",function hasProperty(name/*:**/)/*:Boolean*/
    {
     ...
     *  @productversion Flex 3
     */
    "override public function nextName",function nextName(index/*:int*/)/*:String*/
    {
     ...
     *  @productversion Flex 3
     */
    "override public function nextNameIndex",function nextNameIndex(index/*:int*/)/*:int*/
    {        
     ...
     *  @productversion Flex 3
     */
    "override public function nextValue",function nextValue(index/*:int*/)/*:**/
    {
     ...
     *  @productversion Flex 3
     */
    "override public function setProperty",function setProperty(name/*:**/, value/*:**/)/*:void*/
    {
