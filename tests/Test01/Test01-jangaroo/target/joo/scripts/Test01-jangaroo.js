...
];},[],["flash.display.Sprite","flash.geom.Matrix","Math","flash.display.GradientType","Array","Particle","flash.display.Bitmap","flash.display.BitmapData","flash.display.PixelSnapping","flash.display.Shape","flash.events.Event","FPS","flash.geom.ColorTransform"]
);
// class FPS
joo.classLoader.prepare("package",
...
];},[],["flash.text.TextField","flash.text.TextFormat","flash.events.Event"]
);
// class Particle
joo.classLoader.prepare("package",
...
"public function Test01",function()
{this[$super]();
