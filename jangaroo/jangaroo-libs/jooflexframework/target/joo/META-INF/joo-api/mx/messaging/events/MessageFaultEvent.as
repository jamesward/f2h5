 ...
 */
public class MessageFaultEvent extends flash.events.Event
{
    //--------------------------------------------------------------------------
    //
    // Static Constants
     ...
     *  @productversion LCDS 3 
     */
    public static native function createEvent(msg:ErrorMessage):MessageFaultEvent;
     ...
     *  @productversion LCDS 3 
     */
    public native function MessageFaultEvent(type:String, bubbles:Boolean = false, cancelable:Boolean = false,
     ...
     *  @productversion LCDS 3 
     */
    public native function get rootCause():Object;
