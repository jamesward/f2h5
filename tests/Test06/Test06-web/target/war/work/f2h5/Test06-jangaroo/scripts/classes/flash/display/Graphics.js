...
"public class Graphics",function($$l,$$private){var is=joo.is,assert=joo.assert,trace=joo.trace,$$bound=joo.boundMethod,$super=$$l+'super',$context=$$l+'context',$insideFill=$$l+'insideFill',$_beginFill=$$l+'_beginFill',$createGradientStyle=$$l+'createGradientStyle';return[function(){joo.classLoader.init(flash.geom.Matrix,flash.display.CapsStyle,Math,flash.display.GradientType,flash.display.JointStyle,flash.geom.Point);}, 
   ...
   * @see JointStyle
   */
  "public function lineStyle",function lineStyle(thickness/* : Number = NaN*/, color/* : uint = 0*/, alpha/* : Number = 1.0*/,
                            pixelHinting/* : Boolean = false*/, scaleMode/* : String = "normal"*/ /*LineScaleMode.NORMAL*/,
                            caps/* : String = null*/,
                            joints/* : String = null*/, miterLimit/* : Number = 3*/)/* : void*/ {if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){thickness = NaN;}color = 0;}alpha = 1.0;}pixelHinting = false;}scaleMode = "normal";}caps = null;}joints = null;}miterLimit = 3;}
    if (!isNaN(thickness)) {
   ...
   */
  "public function lineGradientStyle",function lineGradientStyle(type/*:String*/, colors/*:Array*/, alphas/*:Array*/, ratios/*:Array*/, matrix/*:Matrix = null*/,
                                    spreadMethod/*:String = "pad"*/, interpolationMethod/*:String = "rgb"*/,
                                    focalPointRatio/*:Number = 0*/)/* : void*/ {if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){matrix = null;}spreadMethod = "pad";}interpolationMethod = "rgb";}focalPointRatio = 0;}
...
package {
 ...
 package {
  ...
  "public function beginGradientFill",function beginGradientFill(type/*:String*/, colors/*:Array*/, alphas/*:Array*/, ratios/*:Array*/,
                                    ...
                                    interpolationMethod/*:String = "rgb"*/, focalPointRatio/*:Number = 0*/)/* : void*/ {if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){matrix = null;}spreadMethod = "pad";}interpolationMethod = "rgb";}focalPointRatio = 0;}
  ...
  "public static function toRGBA",function toRGBA(color/* : uint*/, alpha/* : Number = 1.0*/)/* : String*/ {if(arguments.length<2){alpha = 1.0;}
