...
"mx_internal static const",{ VERSION/*:String*/ : "3.3.0.4852"},
    ...
    */
     ...
     */
    "public static function compare",function compare(a/*:Object*/, b/*:Object*/, depth/*:int = -1*/)/*:int*/
...
//                }
                ...
                {
                    var classInfo/*:Object*/ = mx.utils.ObjectUtil.getClassInfo(value, exclude,
                    ...
                    var isDict/*:Boolean*/ = is( value, flash.utils.Dictionary);
                    var prop/*:**/;
                    indent += 2;
     ...
     *  to the given string.
     */
    "private static function newline",function newline(str/*:String*/, n/*:int = 0*/)/*:String*/
...
//            b = ObjectProxy(b).object_proxy::object;
        ...
        if (typeOfA == typeOfB)
        {
            switch(typeOfA)
            {
                ...
                case "number":
                {
                    result = mx.utils.ObjectUtil.numericCompare(a/*as Number*/, b/*as Number*/);
                    break;
                }
                
                case "string":
                {
                    result = mx.utils.ObjectUtil.stringCompare(a/*as String*/, b/*as String*/);
                    break;
                }
                ...
                case "object":
                {
                    ...
                    {
                        result = $$private.arrayCompare(a/*as Array*/, b/*as Array*/, currentDepth, desiredDepth, refs);
                    }
                    else if (( is(a, Date)) && ( is(b, Date)))
                    {
                        result = mx.utils.ObjectUtil.dateCompare(a/*as Date*/, b/*as Date*/);
                    }
                    else if (( is(a, mx.collections.IList)) && ( is(b, mx.collections.IList)))
                    {
                        result = $$private.listCompare(a/*as IList*/, b/*as IList*/, currentDepth, desiredDepth, refs);
                    }
...
//                    }
                    ...
                    {
                        var aProps/*:Array*/ = mx.utils.ObjectUtil.getClassInfo(a).properties;
                        var bProps/*:Array*/;
...
//        return result;
    ...
    {if(arguments.length<5){if(arguments.length<4){excludes = null;}options = null;}
        var classInfo/*:Object*/ = mx.utils.ObjectUtil.getClassInfo(obj, excludes, options);
...
//    }
     ...
     *  @private
     */
    "private static function getCacheKey",function getCacheKey(o/*:Object*/, excludes/*:Array = null*/, options/*:Object = null*/)/*:String*/
    {if(arguments.length<3){if(arguments.length<2){excludes = null;}options = null;}
        var key/*:String*/ = flash.utils.getQualifiedClassName(o);
