 ...
 */
public class FaultEvent extends mx.rpc.events.AbstractEvent
{
    //--------------------------------------------------------------------------
    //
    //  Class constants
    ...
    */
     ...
     *  @productversion Flex 3
     */
    public native function FaultEvent(type:String, bubbles:Boolean = false, cancelable:Boolean = true,
     ...
     *  @productversion Flex 3
     */
    public native function get fault():Fault;
     ...
     *  @productversion Flex 3
     */ 
    public static native function createEventFromMessageFault(value:MessageFaultEvent, token:AsyncToken = null):FaultEvent;
     ...
     *  @productversion Flex 3
     */ 
    public static native function createEvent(fault:Fault, token:AsyncToken = null, msg:IMessage = null):FaultEvent;
}
