 ...
 */
public class MessageEvent extends flash.events.Event
{
    //--------------------------------------------------------------------------
    //
    // Static Constants
     ...
     *  @productversion LCDS 3 
     */
    public static native function createEvent(type:String, msg:IMessage):MessageEvent;
     ...
     *  @productversion LCDS 3 
     */
    public native function MessageEvent(type:String, bubbles:Boolean = false, cancelable:Boolean = false, 
