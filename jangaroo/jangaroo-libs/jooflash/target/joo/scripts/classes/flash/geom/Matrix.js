...
"public class Matrix",function($$l,$$private){var is=joo.is,assert=joo.assert,trace=joo.trace,$$bound=joo.boundMethod,$super=$$l+'super';return[function(){joo.classLoader.init(flash.geom.Point);}, 
   ...
   * @param ty
   */
  "public function Matrix",function $Matrix (a/*:Number = 1*/, b/*:Number = 0*/, c/*:Number = 0*/, d/*:Number = 1*/, tx/*:Number = 0*/, ty/*:Number = 0*/) {if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){a = 1;}b = 0;}c = 0;}d = 1;}tx = 0;}ty = 0;}this[$super]();
    this.a = a;
    this.b = b;
    this.c = c;
    this.d = d;
   ...
   */
  "public function createBox",function createBox(scaleX/*:Number = 1*/, scaleY/*:Number = 1*/, rotation/*:Number = 0*/, tx/*:Number = 0*/, ty/*:Number = 0*/)/* : void*/ {if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){scaleX = 1;}scaleY = 1;}rotation = 0;}tx = 0;}ty = 0;}
   ...
   * @param ty
   */
  "public function createGradientBox",function createGradientBox (width/*:Number = NaN*/, height/*:Number = NaN*/, rotation/*:Number = 0*/, tx/*:Number = 0*/, ty/*:Number = 0*/)/* : void*/ {if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){width = NaN;}height = NaN;}rotation = 0;}tx = 0;}ty = 0;}
