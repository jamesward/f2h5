...
"public static const",{ VERSION/*:String*/ : "4.1.0.16076"},
     ...
     */
    "private static var",{ classMap/*:Object*/ :function(){return( {});}},
     ...
     */
    "public static function registerClass",function registerClass(interfaceName/*:String*/,
										 clazz/*:Class*/)/*:void*/
    {
        var c/*:Class*/ = $$private.classMap[interfaceName];
		if (!c)
     ...
     */
    "public static function getClass",function getClass(interfaceName/*:String*/)/*:Class*/
    {
	 ...
	 *  because the factory class may not have called registerClass() yet.
     */
    "public static function getInstance",function getInstance(interfaceName/*:String*/)/*:Object*/
    {
        var c/*:Class*/ = $$private.classMap[interfaceName];
		if (!c)
		{
