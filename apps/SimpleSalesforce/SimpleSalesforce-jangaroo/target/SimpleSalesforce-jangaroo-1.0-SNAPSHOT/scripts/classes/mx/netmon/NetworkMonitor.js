...
"public class NetworkMonitor",function($$l,$$private){var is=joo.is,assert=joo.assert,trace=joo.trace,$$bound=joo.boundMethod,$super=$$l+'super';return[
     ...
     *  @productversion Flex 3
     */
    "public static var",{ isMonitoringImpl/*:Function*/: undefined},
     ...
     *  @productversion Flex 3
     */
    "public static var",{ adjustURLRequestImpl/*:Function*/: undefined},
     ...
     *  @productversion Flex 3
     */
    "public static var",{ adjustNetConnectionURLImpl/*:Function*/: undefined},
     ...
     *  @productversion Flex 3
     */
    "public static var",{ monitorEventImpl/*:Function*/: undefined},
     ...
     *  @productversion Flex 3
     */
    "public static var",{ monitorInvocationImpl/*:Function*/: undefined},
     ...
     *  @productversion Flex 3
     */
    "public static var",{ monitorResultImpl/*:Function*/: undefined},
     ...
     *  @productversion Flex 3
     */
    "public static var",{ monitorFaultImpl/*:Function*/: undefined},
     ...
     *  @productversion Flex 3
     */
    "public static function isMonitoring",function isMonitoring()/*:Boolean*/
    {
     ...
     *  @productversion Flex 3
     */ 
    "public static function adjustURLRequest",function adjustURLRequest(urlRequest/*:URLRequest*/,
                                            rootURL/*:String*/,
     ...
     *  @productversion Flex 3
     */ 
     "public static function adjustNetConnectionURL",function adjustNetConnectionURL(rootUrl/*:String*/, url/*:String*/)/*:String*/
     {
     ...
     *  @productversion Flex 3
     */
    "public static function monitorEvent",function monitorEvent(event/*:Event*/,
                                        correlationID/*:String*/)/*:void*/
    {
     ...
     *  @productversion Flex 3
     */
    "public static function monitorInvocation",function monitorInvocation(id/*:String*/,
     ...
     *  @productversion Flex 3
     */
    "public static function monitorResult",function monitorResult(resultMessage/*:Object*/,
     ...
     *  @productversion Flex 3
     */
    "public static function monitorFault",function monitorFault(faultMessage/*:Object*/,
