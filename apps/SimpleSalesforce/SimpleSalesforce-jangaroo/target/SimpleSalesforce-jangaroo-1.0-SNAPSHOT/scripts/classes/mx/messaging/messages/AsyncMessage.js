...
"public class AsyncMessage extends mx.messaging.messages.AbstractMessage implements mx.messaging.messages.ISmallMessage",function($$l,$$private){var is=joo.is,assert=joo.assert,trace=joo.trace,$$bound=joo.boundMethod,$super=$$l+'super',$_correlationId=$$l+'_correlationId',$correlationIdBytes=$$l+'correlationIdBytes',$readExternal=$$l+'readExternal',$writeExternal=$$l+'writeExternal',$addDebugAttributes=$$l+'addDebugAttributes';return[function(){joo.classLoader.init(mx.messaging.messages.AsyncMessageExt);},
     ...
     *  @productversion LCDS 3 
     */
    "public function AsyncMessage",function $AsyncMessage(body/*:Object = null*/, headers/*:Object = null*/)
     ...
     * @private
     */
    "private var",{ _correlationId/*:String*/: undefined},

    /**
     * @private
     */
    "private var",{ correlationIdBytes/*:ByteArray*/: undefined},
     ...
     *  @productversion LCDS 3 
     */
    "public function get correlationId",function get$correlationId()/*:String*/
    {
     ...
     * @private
     */
    "public function set correlationId",function set$correlationId(value/*:String*/)/*:void*/
    {
     ...
     * @private
     */
    "public function getSmallMessage",function getSmallMessage()/*:IMessage*/
    {
     ...
     *  @private
     */ 
    "override protected function addDebugAttributes",function addDebugAttributes(attributes/*:Object*/)/*:void*/
    {
