...
"public class MessageFaultEvent extends flash.events.Event",function($$l,$$private){var is=joo.is,assert=joo.assert,trace=joo.trace,$$bound=joo.boundMethod,$super=$$l+'super',$clone=$$l+'clone',$toString=$$l+'toString';return[
     ...
     *  @productversion LCDS 3 
     */
    "public static function createEvent",function createEvent(msg/*:ErrorMessage*/)/*:MessageFaultEvent*/
    {
     ...
     *  @productversion LCDS 3 
     */
    "public function MessageFaultEvent",function $MessageFaultEvent(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/,
     ...
     *  @productversion LCDS 3 
     */
    "public function get rootCause",function get$rootCause()/*:Object*/
    {
